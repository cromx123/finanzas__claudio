...
export default function DividendosPage() {
  ...
  return (
    <>
      ...
      />
      <PageContainer>
        <PageHeader kicker="MÓDULO 4 · CALENDARIO Y FLUJO DE CAJA" title={`Dividendos ${CURRENT_YEAR} — ${portfolio.name}`} aside={notaWh} />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 divide-x divide-y divide-divider border-y-2 border-divider">
          <div className="px-[18px] py-4">
            ...
            <div className="font-sans font-extrabold text-[23px]">{formatCurrency(derived.totalY, ccy, 0)}</div>
          </div>
          <div className="px-[18px] py-4">
            <h6 className="m-0 mb-1 text-[11px] uppercase tracking-[0.08em] font-sans font-extrabold text-neutral-600">Promedio mensual</h6>
            <div className="font-sans font-extrabold text-[23px]">{formatCurrency(derived.totalY / 12, ccy, 0)}</div>
          </div>
          <div className="px-[18px] py-4">
            ...
            <div className="text-muted text-[11px] mt-0.5">{formatCurrency(derived.monthly[derived.best], ccy, 0)}</div>
          </div>
          <div className="px-[18px] py-4">
